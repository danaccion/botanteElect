...
namespace PrintCertificate
{
    public class Print_CertificateCanvList
    {
        ...
        public void createDatasets()
        {
            ...
            ds8 = new DataSet();
            certificateTab8 = new DataTable();
            certificateTab8 = report.GetMemberDetails8(certificateTab8);
            ds8.Tables.Add(certificateTab8);
            certificateTab8.TableName = "certificate_ofcanvass8";

            ds9 = new DataSet();
            certificateTab9 = new DataTable();
            certificateTab9 = report.GetMemberDetails9(certificateTab9);
            ds9.Tables.Add(certificateTab9);
            certificateTab9.TableName = "certificate_ofcanvass9";
        }
